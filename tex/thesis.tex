...
\begin{enumerate}[noitemsep,topsep=2pt]
  ...
  \item \textbf{KNN few-shot block} --- summarised mock forecasts of the three most semantically similar training activities, one from each broad rating tier (see Section~\ref{ssub:nearest_neighbor_vector_similarity_}).
