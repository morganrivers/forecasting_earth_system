...
\begin{itemize}
\item 140: Water Supply \& Sanitation
\item 231: Energy Policy
\item 232: Energy generation, renewable sources
\item 234: Hybrid energy plants
\item 235: Nuclear energy plants
\item 312: Forestry
\item 410: General Environment Protection
\end{itemize}
...
\item 31192: Plant and post-harvest protection and pest control
...
\item 32210: Mineral/mining policy and administrative management
...
\item 43060: Disaster Risk Reduction
\end{itemize}
...
\begin{itemize}
 ...
 \item the one-hot encoded funding organization of the top 4 most common organizations in the database (The World Bank (957 activities)
 \item BMZ/KFW/GIZ (240 activities)
 \item UNDP (257 activities)
 \item and the Asian Development Bank (156 activities))
 \item the Country Policy and Institutional Assessment (CPIA) score from the World Bank for that country
 \item the scope of the activity
 \item the planned duration of the activity
 ...
 \item \emph{gpt-3.5-turbo}-generated finance, activity integratedness with broader activities, implementer performance, ease of targeted outcomes, contextual challenge, overall risks, and overall activity complexity grades.
\end{itemize}
