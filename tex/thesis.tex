...
The forecasting system developed in this thesis could augment or partially replace the prediction market mechanism in this context. Once an evidence database of past aid activities is established, statistical and LLM-based forecasts of activity outcomes are cheap to generate at scale, and do not require active market participants or financial liquidity to function. Rather than waiting for market prices to aggregate beliefs about which intervention will maximize a welfare metric, a forecasting model trained on historical outcomes could directly estimate the conditional expected welfare gain of a proposed activity. This could lower the barrier to applying Futarchy-style decision making in resource-constrained institutional settings, such as development finance, where liquid prediction markets may be impractical to organize but where the evidence base for statistical forecasting is growing.
