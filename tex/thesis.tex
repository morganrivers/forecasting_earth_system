...
The square root of the mean of the squared differences between each prediction and the true value; a measure of average error. Lower is better. Since ratings range from 1 to 6, the maximum possible RMSE is 5. This metric heavily penalizes large errors. RMSE is only used in this work for overall ratings.
...
When dividing by total expenditure reported in IATI, the correlation of aggregate cost-effectiveness Z-scores with the baseline is not statistically significant.

Precisely extracting cost-effectiveness proved more difficult than extracting ratings, owing to inconsistent reporting and unit definitions. \citet{goldembergMindingGapAid2025} found cost-effectiveness easier to forecast than overall ratings; the inverse was found here: cost-effectiveness forecasting did not exceed chance, whereas rating forecasting achieved statistically significant above-chance performance. 
