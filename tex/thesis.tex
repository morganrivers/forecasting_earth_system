...
However, this is not the only way to predict outcomes - statistical, or ``Machine Learning'' (ML) outcomes, while lacking the rigorous mechanistic underlying processes, have recently been shown to perform better in many cases to model complex systems such as language modelling \citewithtitle{brownLanguageModelsAre2020}, protein folding \citewithtitle{jumperHighlyAccurateProtein2021}, biodiversity protection \citewithtitle{silvestroImprovingBiodiversityProtection2022}, and weather forecasting \citewithtitle{lamLearningSkillfulMediumrange2023}.
