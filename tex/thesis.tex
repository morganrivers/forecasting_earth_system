...
One more speculative improvement could be to use time-dependent coefficients on the nonlinear models, which allow for the shifts in influence over time of different features to be captured and projected into the future, capturing the shifting influence of various factors in activity success over time as the importance of pre-activity aspects of projects changes.
